...
slide = slideName.add_slider("camera Y angle", -90, 90, 0)
slide1 = slideName.add_slider("camera X angle", -180, 180, 0)
slide2 = slideName.add_slider("fov", 30, 120, 45)
...
while draw:
    ...
    transformed_eye = eye - obj.center
    rotated_eye = pyrr.matrix44.apply_to_vector(rotation, transformed_eye)
    transformed_eye = rotated_eye + obj.center
    view_matrix = pyrr.matrix44.create_look_at(transformed_eye, look, up)
