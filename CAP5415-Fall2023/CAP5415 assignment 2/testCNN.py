...
def train(model, device, train_loader, optimizer, criterion, epoch, batch_size):
    ...
    #display the average loss and accuyacy for the training set
    print(epoch)
...
def test(model, device, test_loader):
    ...
    #display the average loss and accuracy for test set
...
def run_main(FLAGS):
    ...
    #initialize arrays for training/testing loss and accuracy
    train_loss_arr = np.empty(FLAGS.num_epochs + 1, dtype=object)
    train_accuracy_arr = np.empty(FLAGS.num_epochs + 1, dtype=object)
    test_loss_arr = np.empty(FLAGS.num_epochs + 1, dtype=object)
    test_accuracy_arr = np.empty(FLAGS.num_epochs + 1, dtype=object)
    ...
    with open('output.txt', 'w') as f:
        ...
        f.write("Training and evaluation finished")
