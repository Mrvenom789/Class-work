...
node_t * addTree(node_t * t1, node_t * t2)//adds the values of the two trees
{
    if(t1 == NULL && t2 == NULL)//both trees are NULL
        return NULL;

    if(t1 == NULL && t2 != NULL) //tree1 is NULL, tree2 has a value
    {
    ...
    if(t1 != NULL && t2 == NULL) //tree1 has a value, tree2 is NULL
    {
        return t1;
    }
    else //both trees have a value
    {
...
node_t * subtractTree(node_t * t1, node_t * t2)//subtracts the values of the two trees
{
    if(t1 == NULL && t2 == NULL)//both trees are NULL
        return NULL;
